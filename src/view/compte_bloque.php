...
<form id="compte_bloque" action="../controller/insert_compte_bloque.php" method="POST">
...
<div>
                ...
                <div>
                <label> delai_blocage:</label>
                        <input type="text" name="delai_blocage" id="delai_blocage+" placeholder="Entrer le delai_blocage"></p>
                </div>
